...
for file in file_names:
    ...
    vit_embedding = vit_embedding.to(torch.device("cpu"))
    tensors.append(vit_embedding)

final_tensor = torch.cat(tensors, 0)
final_tensor = final_tensor.reshape((-1, 768))

torch.save(final_tensor, "vit_tensors.pt")
